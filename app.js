...
async function main() {
    ...
    const DOMAIN = await getVariableValue('DOMAIN', 'aaa7-bb-7topplug-400-topnet7-366906238292.us-east1.run.app');// 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
