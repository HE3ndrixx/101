...
async function main() {
    ...
    const DOMAIN = await getVariableValue('DOMAIN', 'aaaaaaa7-101-7switching-protocols-topnet7-1009366943064.us-east4.run.app');// 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
